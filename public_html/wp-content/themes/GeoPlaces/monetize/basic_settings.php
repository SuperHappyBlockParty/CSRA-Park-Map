...
function registration_email($user_id)
{
		...
		$store_login_link = '<a href="'.$site_url.'/?ptype=login&akey='.$activation_key.'&uid='.$user_id.'">'.$site_url.'/?ptype=login&akey='.$activation_key.'&uid='.$user_id.'</a>';
		$store_login = sprintf(__('<a href="'.home_url().'/?ptype=login&akey='.$activation_key.'&uid='.$user_id.'">'.'Click Login'.'</a>','templatic'));
