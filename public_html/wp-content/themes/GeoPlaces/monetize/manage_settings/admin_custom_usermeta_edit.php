...
<form action="<?php echo home_url();?>/wp-admin/admin.php?page=manage_settings&mod=user_meta&act=addedit#option_display_custom_usermeta" method="post" name="custom_fields_frm" onsubmit="return chk_userfield_form();">
 ...
 <div class="option option-select" >
  ...
  <div class="option option-select" id="on_registration_id"  <?php if($post_val->ctype=='head'){?> style="display:none;" <?php }else{?> style="display:block;" <?php }?>>
    <h3><?php _e('Show on Registration page?: ','templatic');?></h3>
    <div class="section">
      <div class="element">
           <select name="on_registration" id="on_registration" <?php if($post_val->is_delete=='1'){?> disabled="disabled" <?php }?>>
          <option value="1" <?php if($post_val->on_registration=='1'){ echo 'selected="selected"';}?>><?php _e('Yes','templatic');?></option>
          <option value="0" <?php if($post_val->on_registration=='0'){ echo 'selected="selected"';}?>><?php _e('No','templatic');?></option>
          </select>
   		</div>
  ...
  <div class="option option-select" id="on_profile_id"  <?php if($post_val->ctype=='head'){?> style="display:none;" <?php }else{?> style="display:block;" <?php }?>>
    <h3><?php _e('Show On Profile Page ? : ','templatic');?></h3>
    <div class="section"> 
      <div class="element">
           <select name="on_profile" id="on_profile" <?php if($post_val->is_delete=='1'){?> disabled="disabled" <?php }?>>
          <option value="1" <?php if($post_val->on_profile=='1'){ echo 'selected="selected"';}?>><?php _e('Yes','templatic');?></option>
          <option value="0" <?php if($post_val->on_profile=='0'){ echo 'selected="selected"';}?>><?php _e('No','templatic');?></option>
          </select>
   		</div>
...
function usershow_option_add(htmltype)
{
	...
	if(htmltype=='head')
	{
		...
		document.getElementById('on_registration_id').style.display='none';	
		document.getElementById('on_profile_id').style.display='none';	
	...
	else
	{
		...
		document.getElementById('on_registration_id').style.display='';	
		document.getElementById('on_profile_id').style.display='';	
