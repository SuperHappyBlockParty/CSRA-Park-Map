...
<a href="<?php echo home_url().'/wp-admin/admin.php?page=manage_settings&mod=user_meta#option_display_custom_usermeta';?>" title="<?php _e('Add a field for users&rsquo; profile','templatic');?>" name="btnviewlisting" class="l_add_new" /><?php _e('Add a new field','templatic'); ?></a>
</h4>

 <p class="notes_spec"><?php _e('User profile fields are displayed in the user&rsquo;s dashboard and profile area. User profile fields allow you to collect additional user information about the user on registration.','templatic');?></p>
