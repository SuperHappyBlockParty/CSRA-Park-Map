...
if($priceinfo) {
	foreach($priceinfo as $priceinfoObj) { ?>
		...
		<td colspan="6">
			...
			<tr><td><?php echo PRICE_TYPE." :"; ?><strong><?php echo $priceinfoObj->price_post_type;?></strong></td>
