...
<h4><?php _e('Enable coupon option on &lsquo;Add place/event&rsquo; page','templatic');?></h4> 
...
<h4><?php _e('Manage Coupon','templatic');?>
 ...
 <a href="<?php echo home_url().'/wp-admin/admin.php?page=manage_settings&mod=coupon#option_display_coupon';?>" title="<?php _e('Add New Coupon','templatic');?>" name="btnviewlisting" class="l_add_new" /><?php _e('Add New Coupon','templatic'); ?></a>
</h4>
