...
if($_SESSION)
{	global $site_url;
	if (  $_SESSION['event_info']['user_email'] == '' )	{
	...
	$user_twitter = $_SESSION['event_info']['user_twitter'];
	$user_facebook = $_SESSION['event_info']['user_facebook'];
	$userName = $_SESSION['event_info']['user_fname'];
	...
	$user_address_info = array(
							...
							"first_name"	=>	$_SESSION['event_info']['user_fname'],					
							);
