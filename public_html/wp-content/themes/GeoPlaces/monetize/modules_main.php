...
if(file_exists(TT_MODULES_FOLDER_PATH . 'registration/registration_functions.php'))
{
	...
	include_once(TT_MODULES_FOLDER_PATH . 'registration/lang_reg.php');
}
...
if(file_exists(TT_MODULES_FOLDER_PATH . 'place/place_main.php'))
{
	include_once (TT_MODULES_FOLDER_PATH . 'place/place_main.php');
}
