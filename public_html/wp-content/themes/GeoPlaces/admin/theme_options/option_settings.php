...
{
	echo '<script type="text/javascript">var ajax_option_url_var = "'.home_url().'/wp-admin/";</script>';	
}
...
// enqueue styles
wp_enqueue_style( 'option-tree-style',TT_THEME_OPTIONS_FOLDER_URL.'css/option_tree_style.css',  'screen');	
// enqueue scripts
add_thickbox();
