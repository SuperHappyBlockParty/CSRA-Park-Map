  ...
  <div id="content_wrap">
    <form method="post" id="the-theme-options">
      <div class="info top-info">
        <input type="submit" value="<?php echo SAVE_ALL_CHANGES_TEXT; ?>" class="button-framework button-framework-imp save-options" name="submit"/>
      </div>
      ...
      <div class="info bottom">
        ...
        <input type="submit" value="<?php echo RESET_OPTIONS_TEXT; ?>" class="button-framework reset" name="reset"/>
        <input type="submit" value="<?php echo SAVE_ALL_CHANGES_TEXT; ?>" class="button-framework save-options button-framework-imp" name="submit"/>
